...
public class LoginManager {
	 ...
	 * @param clientType enum based on client types
	 * @return 
	 * @return a service type based by ClientType enum
	 * @throws CouponSystemException if login would fail for some reason
	 */
